...
def _resolve_timeout(timeout: float | httpx.Timeout | None) -> httpx.Timeout | None:
    if timeout is None:
        return None
...
def _client_with_timeout(
    ...
    if resolved_timeout is None:
        return client
    return evolve(client, timeout=resolved_timeout)
...
class QuercleClient:
    ...
    def fetch(self, url: str, prompt: str, *, timeout: float | httpx.Timeout | None = None) -> FetchResponse200:
        body = FetchBody.from_dict({"url": url, "prompt": prompt})
        response = fetch_sync_detailed(client=_client_with_timeout(self._client, timeout), body=body)
    ...
    def search(
        ...
        *,
        ...
        response = search_sync_detailed(client=_client_with_timeout(self._client, timeout), body=SearchBody.from_dict(body_payload))
    ...
    def raw_fetch(
        ...
        *,
        ...
        response = raw_fetch_sync_detailed(client=_client_with_timeout(self._client, timeout), body=RawFetchBody.from_dict(body_payload))
    ...
    def raw_search(
        ...
        *,
        ...
        response = raw_search_sync_detailed(client=_client_with_timeout(self._client, timeout), body=RawSearchBody.from_dict(body_payload))
    ...
    def extract(
        ...
        *,
        ...
        response = extract_sync_detailed(client=_client_with_timeout(self._client, timeout), body=ExtractBody.from_dict(body_payload))
...
class AsyncQuercleClient:
    ...
    async def fetch(self, url: str, prompt: str, *, timeout: float | httpx.Timeout | None = None) -> FetchResponse200:
        body = FetchBody.from_dict({"url": url, "prompt": prompt})
        response = await fetch_async_detailed(client=_client_with_timeout(self._client, timeout), body=body)
        parsed = _ensure_ok("fetch", response)
        if isinstance(parsed, FetchResponse200):
            return parsed
        raise QuercleApiError("fetch", int(response.status_code), "Unexpected response payload", parsed)
    ...
    async def search(
        ...
        *,
        ...
        response = await search_async_detailed(client=_client_with_timeout(self._client, timeout), body=SearchBody.from_dict(body_payload))
        parsed = _ensure_ok("search", response)
        if isinstance(parsed, SearchResponse200):
            return parsed
        raise QuercleApiError("search", int(response.status_code), "Unexpected response payload", parsed)
    ...
    async def raw_fetch(
        ...
        *,
        ...
        response = await raw_fetch_async_detailed(client=_client_with_timeout(self._client, timeout), body=RawFetchBody.from_dict(body_payload))
        parsed = _ensure_ok("raw_fetch", response)
        if isinstance(parsed, RawFetchResponse200):
            return parsed
        raise QuercleApiError("raw_fetch", int(response.status_code), "Unexpected response payload", parsed)
    ...
    async def raw_search(
        ...
        *,
        ...
        response = await raw_search_async_detailed(client=_client_with_timeout(self._client, timeout), body=RawSearchBody.from_dict(body_payload))
        parsed = _ensure_ok("raw_search", response)
        if isinstance(parsed, (RawSearchResponse200Type0, RawSearchResponse200Type1)):
            return parsed
        raise QuercleApiError("raw_search", int(response.status_code), "Unexpected response payload", parsed)
    ...
    async def extract(
        ...
        *,
        ...
        response = await extract_async_detailed(client=_client_with_timeout(self._client, timeout), body=ExtractBody.from_dict(body_payload))
        parsed = _ensure_ok("extract", response)
        if isinstance(parsed, (ExtractResponse200Type0, ExtractResponse200Type1)):
            return parsed
        raise QuercleApiError("extract", int(response.status_code), "Unexpected response payload", parsed)
