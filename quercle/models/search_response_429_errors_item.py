...
T = TypeVar("T", bound="SearchResponse429ErrorsItem")


@_attrs_define
class SearchResponse429ErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_response_429_errors_item = cls(
            code=code,
            path=path,
            message=message,
        )

        return search_response_429_errors_item
