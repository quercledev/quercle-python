...
T = TypeVar("T", bound="RawFetchResponse429ErrorsItem")


@_attrs_define
class RawFetchResponse429ErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        raw_fetch_response_429_errors_item = cls(
            code=code,
            path=path,
            message=message,
        )

        return raw_fetch_response_429_errors_item
