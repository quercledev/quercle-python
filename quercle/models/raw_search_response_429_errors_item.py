...
T = TypeVar("T", bound="RawSearchResponse429ErrorsItem")


@_attrs_define
class RawSearchResponse429ErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        raw_search_response_429_errors_item = cls(
            code=code,
            path=path,
            message=message,
        )

        return raw_search_response_429_errors_item
