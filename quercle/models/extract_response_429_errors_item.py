...
T = TypeVar("T", bound="ExtractResponse429ErrorsItem")


@_attrs_define
class ExtractResponse429ErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        extract_response_429_errors_item = cls(
            code=code,
            path=path,
            message=message,
        )

        return extract_response_429_errors_item
